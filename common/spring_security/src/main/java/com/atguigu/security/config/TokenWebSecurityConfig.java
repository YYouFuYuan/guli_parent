...
public class TokenWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private UserDetailsService userDetailsService;          //用户类
    private TokenManager tokenManager;                      //token生成器
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.exceptionHandling()
                ...
                .addLogoutHandler(new TokenLogoutHandler(tokenManager,redisTemplate)).and() //登出业务处理器
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(userDetailsService).passwordEncoder(defaultPasswordEncoder); //规定对用户进行怎样的密码处理
    }
